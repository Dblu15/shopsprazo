...
export default function OfferRelatedProducts() {
                ...
                <div className="row">
                    <div className="section-detail">
                        <div className="sp-title">
                            ...
                            <h2 data-cursor="big" aria-label="Related products" style={{ perspective: "500px" }}>
                                <div className="split-line" aria-hidden="true" style={{ position: "relative", display: "block", textAlign: "start" }}>
                                    <div aria-hidden="true" style={{ position: "relative", display: "inline-block" }}>Related</div>{" "}
                ...
                <div className="mtb-minus-12">
                    <div className="sp-popular-slider" style={{ position: 'relative' }}>
                        <Swiper
                            ...
                            speed={1000}
                            navigation={{
                                nextEl: '.custom-nav-next-offer-rel',
                                prevEl: '.custom-nav-prev-offer-rel',
                            }}
                        ...
                        <div className="owl-nav">
                            <button type="button" className="owl-prev custom-nav-prev-offer-rel"></button>
                            <button type="button" className="owl-next custom-nav-next-offer-rel"></button>
                        </div>
                    </div>
                </div>
            </div>
