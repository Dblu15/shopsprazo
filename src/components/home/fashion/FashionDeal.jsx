...
export default function FashionDeal() {
    ...
    return (
        <section className="sp-deal-2 padding-tb-50">
                ...
                <div className="row">
                    <div className="col-lg-8">
                        <div className="deal-box box-1">
                            ...
                            <img src="/images/3.png" className="character" alt="deal" />
                        </div>
                    </div>
                    <div className="col-lg-4">
                        <div className="deal-box box-2">
                            <div className="sp-icon-set"></div>
                            <div className="deal-detail">
                                <h3>Women&apos;s Gown<span>100% Cotton</span></h3>
                                <Link href="/shop" className="sp-btn-4"><i className="ri-handbag-line"></i>Shop Now</Link>
                                <div className="limit">
                            ...
                            <img src="/images/4.png" className="character" alt="deal" />
                        </div>
                    </div>
                </div>
            </div>
