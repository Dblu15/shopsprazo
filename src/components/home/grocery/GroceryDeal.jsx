...
export default function GroceryDeal() {
    return (
        <section className="sp-deal padding-tb-50 aos-init" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="200">
                    ...
                    <div className="col-lg-8">
                        <div className="deal-box box-1">
                            ...
                            <div className="deal-detail">
                                ...
                                <div className="timer deal-timer" data-date="September 30, 2027 19:15:10 PDT">
                                    <div className="deal-timer">
                                        <div className="time-block">
                                            <div className="time">569</div><span className="text">Days</span>
                                        </div>
                                        <div className="time-block">
                                            <div className="time">18</div><span className="text">Hours</span>
                                        </div>
                                        <div className="time-block">
                                            <div className="time">46</div><span className="text">Minute</span>
                                        </div>
                                        <div className="time-block">
                                            <div className="time">40</div><span className="text">Second</span>
                                        </div>
                                    </div>
                                </div>
                                <a href="/shop" className="sp-btn-4"><i className="ri-handbag-line"></i>Shop Now</a>
                            </div>
