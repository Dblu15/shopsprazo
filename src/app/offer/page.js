...
import OfferRelatedProducts from "@/components/offer/OfferRelatedProducts";

export const metadata = {
    title: "Special Offers - Sprazo",
    description: "Check out the latest deals and offers on Sprazo",
};
...
export default function OfferPage() {
    return (
        <>
                    ...
                    <div className="row">
                        <div className="col-12">
                            <div className="sp-breadcrumb-inner">
                                <h2 data-cursor="big" className="sp-breadcrumb-title">Offer Page</h2>
                                <ul className="sp-breadcrumb-list">
                                    ...
                                    <li className="sp-breadcrumb-item active">Offer Page</li>
                                </ul>
                            </div>
                        </div>
                    </div>
            ...
            {/* Deal Section */}
            <section className="sp-deal padding-tb-50" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="200">
                <h2 data-cursor="big" className="d-none">Hot Deals</h2>
                    ...
                    <div className="row">
                        <div className="col-lg-8">
                            <div className="deal-box box-1">
                                ...
                                <div className="deal-detail">
                                    <p><img src="/fonts/15.svg" alt="" /> Deal of the Week</p>
                                    <h3>Hurry Up! Offer ends in.<span>Get UP TO 80% OFF</span></h3>
                                    <div className="timer deal-timer" data-date="September 30, 2027 19:15:10 PDT"></div>
                                    <Link href="/shop" className="sp-btn-4"><i className="ri-handbag-line"></i>Shop Now</Link>
                                </div>
                        ...
                        <div className="col-lg-4">
                            <div className="deal-box box-2">
                                <div className="deal-detail">
                                    <h3>Fresh Fruits<span>100% Organic</span></h3>
                                    <Link href="/shop" className="sp-btn-4"><i className="ri-handbag-line"></i>Shop Now</Link>
                                    <div className="limit">
            ...
            {/* Banner Section */}
            <section className="sp-banner padding-tb-50">
                <div className="container">
                    <div className="row">
                        <div className="col-lg-4 col-md-6 col-12 mb-24">
                            <div className="item bnr bnr-1" style={{ backgroundSize: "100%" }}>
                                <div className="sp-details">
                                    ...
                                    <div className="sp-bnr-text">
                                        <h3>
                                            <span className="text_bg">Get up to 15% off Discounts</span>
                                        </h3>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="col-lg-4 col-md-6 col-12 mb-24">
                            <div className="item bnr bnr-2" style={{ backgroundSize: "100%" }}>
                                <div className="sp-details">
                                    <div className="btns">
                                        <Link href="/shop" className="btn sp-btn-1">Shop Now</Link>
                                        <a href="#" className="sp-wish"><i className="ri-heart-line"></i></a>
                                    ...
                                    <div className="sp-bnr-text">
                                        <h3>
                                            <span className="text_bg">Get up to 35% off Discounts</span>
                                        </h3>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="col-lg-4 col-md-6 col-12 mb-24">
                            <div className="item bnr bnr-3" style={{ backgroundSize: "100%" }}>
                                <div className="sp-details">
                                    <div className="btns">
                                        <Link href="/shop" className="btn sp-btn-1">Shop Now</Link>
                                        <a href="#" className="sp-wish"><i className="ri-heart-line"></i></a>
                                    ...
                                    <div className="sp-bnr-text">
                                        <h3>
                                            <span className="text_bg">Get up to 20% off Discounts</span>
                                        </h3>
                                    </div>
                                </div>
                            </div>
